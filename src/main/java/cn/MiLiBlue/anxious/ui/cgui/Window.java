...
import cn.MiLiBlue.anxious.utils.RenderUtil;
...
public class Window
{
    ...
    public Window(final Category category, final int x, final int y) {
        ...
        this.max = 120;
        int y2 = y + 25;
        for (final Module c : Client.instance.moduleManager.getModules()) {
    ...
    public void render(final int mouseX, final int mouseY) {
        ...
        if (isOnPanel) {
            ...
            RenderUtil.rectangleBordered(this.x, this.y, this.x + 90, this.y + 1.0 + this.expand, 1.0, new Color(220, 220, 220).getRGB(), new Color(220, 220, 220).getRGB());
        RenderUtil.drawGradientRect(this.x, this.y, this.x + 90, this.y + 17, new Color(220, 220, 220).getRGB(), new Color(220, 220, 220).getRGB());
        final ScaledResolution res = new ScaledResolution(Minecraft.getMinecraft());
        if (this.category.name().equals("Combat")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Combat", this.x + 54, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.category.name().equals("Render")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Visual", this.x + 62, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.category.name().equals("Movement")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Movement", this.x + 43, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.category.name().equals("Player")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Player", this.x + 58, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.category.name().equals("World")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Other", this.x + 61, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.category.name().equals("Elements")) {
            Minecraft.getMinecraft().fontRendererObj.drawString("Elements", this.x + 51, this.y + 6, new Color(25, 25, 25).getRGB());
        }
        if (this.expand > 0) {
