...
public class Projectiles extends Module {
    ...
    public void onRender(final RenderWorldLastEvent event) {
        ...
        try {
            ...
            double posY = renderPosY + mc.thePlayer.getEyeHeight() - 0.10000000149011612;
            ...
            double motionY = -MathHelper.sin((pitch + ((item instanceof ItemPotion && ItemPotion.isSplash(mc.thePlayer.getHeldItem().getItemDamage())) ? -20 : 0)) / 180.0f * 3.1415927f) * (isBow ? 1.0 : 0.4);
            ...
            while (!hasLanded && posY > 0.0) {
                ...
                landingPosition = mc.theWorld.rayTraceBlocks((Vec3)posBefore, posAfter, false, true, false);
                ...
                if (n <= chunkMaxX) {
                    ...
                    do {
                        ...
                        do {
                            z = n2++;
                            mc.theWorld.getChunkFromChunkCoords(x, z).getEntitiesWithinAABBForEntity((Entity) mc.thePlayer, arrowBox, (List)collidedEntities, (Predicate)null);
                        } while (z != chunkMaxZ);
                    } while (x != chunkMaxX);
                }
                ...
                if (mc.theWorld.getBlockState(new BlockPos(posX += motionX, posY += motionY, posZ += motionZ)).getBlock().getMaterial() == Material.water) {
                    motionX *= 0.6;
                    motionY *= 0.6;
                    motionZ *= 0.6;
                }
            ...
            RenderUtil.enableGlCap((int[])posBefore);
            posBefore = new int[] { 2929, 3008, 3553 };
            RenderUtil.disableGlCap((int[])posBefore);
            ...
            if (landingPosition != null) {
                ...
                RenderUtil.drawAxisAlignedBB(new AxisAlignedBB(-0.5, 0.0, -0.5, 0.5, 0.1, 0.5), color, true, true, 3.0f);
            }
            GL11.glPopMatrix();
